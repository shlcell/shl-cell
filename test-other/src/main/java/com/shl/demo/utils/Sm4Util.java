...
public class Sm4Util {
    ...
    public static final String SM4_KEY = "04U65fS2cDWu8wC5";
    ...
    public static class SM4 {
        ...
        public byte[] sm4_crypt_ecb(SM4_Context ctx, byte[] input) throws Exception {
            ...
            if (ctx.isPadding && ctx.mode == SM4_DECRYPT) {
                ...
                int i = outputStr.indexOf('\0');
                if (i > 0) {
                    outputStr = outputStr.substring(0, outputStr.indexOf('\0'));
                }
                output = padding(outputStr.getBytes(), SM4_DECRYPT);
            }
            bins.close();
            bous.close();
            return output;
     ...
     * 封装SM4加密函数
     */
    public static String encryptData_ECB(String plainContent, String secretKey) throws Exception {
        byte[] enc_outbuf = (plainContent + "\0").getBytes();
        byte[] encrypted = encryptData_ECB(enc_outbuf, secretKey.substring(0, 16));
     ...
     * 封装SM4解密函数
     */
    public static String decryptData_ECB(String cipherContent, String secretKey) throws Exception {
        byte[] decrypted = decryptData_ECB(new Base64().decode(cipherContent), secretKey.substring(0, 16));
        return new String(decrypted).trim();
    }

    public static void main(String[] args) throws Exception {
        String str = "[{\"dataType\":1,\"content\":\"[{\\\"name\\\":\\\"abd\\\",\\\"age\\\":19},{\\\"name\\\":\\\"dfg\\\",\\\"age\\\":21}]\"},{\"dataType\":2,\"content\":\"[{\\\"name\\\":\\\"abd\\\",\\\"age\\\":19},{\\\"name\\\":\\\"dfg\\\",\\\"age\\\":21}]\"}]";
        System.out.println(encryptData_ECB(str, SM4_KEY));
    }
}
